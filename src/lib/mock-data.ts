...
export const personas: Persona[] = [
  ...
  {
    id: "p2", name: "Renzo", slug: "renzo", color: "#8b5cf6",
    role: "researcher",
    personality: "Systematic thinker who builds mental models before diving in. Keeps meticulous notes.",
    skills: ["Research", "Analysis", "Documentation", "Investigation"],
    processes: ["Deep dives", "Report writing", "Data gathering"],
    goals: ["Thorough understanding", "Clear documentation", "No assumptions"],
    permissions: { tools: ["docs", "search", "read"], folders: ["docs/", "research/"] },
  },
  {
