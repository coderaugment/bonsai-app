        ...
        <div className="flex-1 flex flex-col px-10 py-8 gap-6 overflow-y-auto">
          ...
          <div className="flex-1 flex flex-col min-h-0">
            ...
            <textarea
              ...
              autoFocus
              className="flex-1 w-full px-5 py-4 rounded-lg text-base leading-relaxed outline-none transition-all resize-none bg-[var(--bg-input)] border border-[var(--border-medium)] text-[var(--text-primary)] placeholder:text-[var(--text-muted)] focus:border-[var(--accent-blue)]"
            />
          </div>
          ...
          <div className="flex-1 flex flex-col min-h-0">
            ...
            <textarea
              ...
              className="flex-1 w-full px-5 py-4 rounded-lg text-base leading-relaxed outline-none transition-all resize-none bg-[var(--bg-input)] border border-[var(--border-medium)] text-[var(--text-primary)] placeholder:text-[var(--text-muted)] min-h-[120px] focus:border-[var(--accent-blue)]"
            />
          </div>
        </div>
